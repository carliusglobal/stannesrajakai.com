                ...
                <section>
                    <div class="tm-post-heading">
                        <span class="tm-circle-small-border">
            				<img width="100" height="100" src="<?=asset_url();?>/images/img_pastors_003-100x100.jpg" class="attachment-post-small-circular-thumbnails wp-post-image" alt="img_pastors_003" />        
        				</span>
                            ...
                            <div data-uk-slider class="tm-sermons-post-gallery">
                                <div class="uk-slider-container post-gallery">
                                    <ul class="uk-slider uk-grid-width-medium-1-1">
                                        <li>
                                            <a data-uk-lightbox data-lightbox-type="image" href="<?=asset_url();?>/images/gall-img-012.jpg"><img width="2000" height="1570" src="<?=asset_url();?>/images/gall-img-012.jpg" class="attachment-full" alt="NEWS" />
                                            </a>
                                        </li>
                                    </ul>
                ...
                <div class="uk-grid">
                    <div class="uk-width-1-1">
                        <div class="uk-panel tm-category-widget-box">
                            <img width="82" height="70" src="<?=asset_url();?>/images/gall-img-0071-82x70.jpg" class="attachment-post-small-thumbnails wp-post-image" alt="SERMONS" />
                    ...
                    <div class="uk-width-1-1">
                        <div class="uk-panel tm-category-widget-box">
                            <img width="82" height="70" src="<?=asset_url();?>/images/gall-img-006-82x70.jpg" class="attachment-post-small-thumbnails wp-post-image" alt="NEWS" />
                            <div class="tm-post-text-block">
                    ...
                    <div class="uk-width-1-1">
                        <div class="uk-panel tm-category-widget-box">
                            <img width="82" height="70" src="<?=asset_url();?>/images/img_testim_004-82x70.jpg" class="attachment-post-small-thumbnails wp-post-image" alt="img_testim_004" />
                            <div class="tm-post-text-block">
