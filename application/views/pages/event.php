        ...
        <aside class="tm-sidebar-b uk-width-medium-1-4 tm-middle">
            ...
            <div class="uk-panel CuteEventGallery">
                ...
                <div class="tm-widget-post-image">
                    <a href="#"><img width="82" height="70" src="<?=asset_url();?>/images/gall-img-011-82x70.jpg" class="attachment-post-small-thumbnails wp-post-image" alt="gall-img-011" />
                    </a>
                </div>
                <div class="tm-widget-post-image">
                    <a href="#"><img width="82" height="70" src="<?=asset_url();?>/images/gall-img-0031-82x70.jpg" class="attachment-post-small-thumbnails wp-post-image" alt="NEWS" />
                    </a>
                </div>
                <div class="tm-widget-post-image">
                    <a href="#"><img width="82" height="70" src="<?=asset_url();?>/images/gall-img-006-82x70.jpg" class="attachment-post-small-thumbnails wp-post-image" alt="NEWS" />
                    </a>
                </div>
                <div class="tm-widget-post-image">
                    <a href="#"><img width="82" height="70" src="<?=asset_url();?>/images/gall-img-0041-82x70.jpg" class="attachment-post-small-thumbnails wp-post-image" alt="EVENTS" />
                    </a>
                </div>
                <div class="tm-widget-post-image">
                    <a href="#"><img width="82" height="70" src="<?=asset_url();?>/images/gall-img-0081-82x70.jpg" class="attachment-post-small-thumbnails wp-post-image" alt="GALLERY" />
                    </a>
                </div>
                <div class="tm-widget-post-image">
                    <a href="#"><img width="82" height="70" src="<?=asset_url();?>/images/slider-img-01-82x70.jpg" class="attachment-post-small-thumbnails wp-post-image" alt="slider-img-01" />
                    </a>
                </div>
            </div>
        </aside>
