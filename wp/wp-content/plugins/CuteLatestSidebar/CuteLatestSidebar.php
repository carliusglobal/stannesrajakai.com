<?php
/*
  Plugin Name: Cute Latest Posts (sidebar)
  Plugin URI: Plugin URI: http://themeforest.net/user/torbara/
  Description: Display Latest Posts (sidebar)
  Author: ovvod
  Version: 1
  Author URI:
 */

class CuteLatestSidebar extends WP_Widget {
    
    function __construct() {
        $widget_ops = array('classname' => 'CuteLatestSidebar', 'description' => 'Display Latest posts');
        parent::__construct('CuteLatestSidebar', 'Cute Latest Posts (sidebar)', $widget_ops);
    }
    ...
    function form($instance) {
        ...
        if(isset($instance['title'] )){
            ...
            $title =  "Cute Latest Posts (sidebar)";
        }
    ...
    function widget($args, $instance) {
        ...
        <div class=""><?php
            foreach ($list as $post) { ?>
                <div class="tm-latest-post-widget-sidebar">
                    <div class="post-date">
                        <div class="day">
                    ...
                    <div class="">
                        <h5><a href="<?php echo get_permalink($post->ID); ?>"><?php echo wp_trim_words($post->post_title, 6); ?></a></h5>
                    </div>
                    <div class="grey">
...
add_action('widgets_init', create_function('', 'return register_widget("CuteLatestSidebar");')); ?>