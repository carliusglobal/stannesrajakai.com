<?php
/*
Plugin Name: Cute Category Posts
Plugin URI: Plugin URI: http://themeforest.net/user/torbara/
Description: Display posts from single category
Author: ovvod
Version: 1.0.0
Author URI: 
*/
...
function category_posts_widget_styles() {
	wp_register_style( 'Cute-category-posts', plugins_url( 'Cute-category-posts/cat-posts.css' ) );
	wp_enqueue_style( 'Cute-category-posts' );
}
...
class CategoryPosts extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct('Cute-category-posts', __('Cute Category Posts'), $widget_ops);
	}
	  ...
	  $cat_posts = new WP_Query(
		...
		?>
			<li class="cat-post-item">
				...
				<p class="post-authore">Posted by: <?php the_author(); ?></p>
				...
				<p class="post-date">
                    ...
                    <a class="uk-button" href="https://www.youtube.com/watch?v=yZHWTNvYpcU" data-uk-lightbox ><i class="uk-icon-video-camera"></i></a>
                    <a class="uk-button" href="#modal-audio" data-uk-modal="">
                        <i class="uk-icon-headphones">
                        </i>
                    </a>
                    <a class="uk-button" href=""><i class="uk-icon-file-pdf-o"></i></a>
                    <a class="uk-button" href=""><i class="uk-icon-file-text"></i></a>
                </p>
			</li>
			<?php
		}
